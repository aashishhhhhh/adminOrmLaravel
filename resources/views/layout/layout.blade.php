  ...
  <body>
    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <a href="{{url('seePost')}}" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>See Posts</span></a>

                        @else
                        <a href="{{url('addPost')}}" class="btn btn-danger" ><i class="material-icons">&#xE15C;</i> <span>Add Post</span></a>						
